      ...
      child: Scaffold(
        body: Column(
          children: [
            ...
            //     //     spreadRadius: 1,
            //     //     blurRadius: 2,
            //     // d    offset: Offset(0, 3), // changes position of shadow
            //     //   ),
            //     // ],
            //   ),
            ...
            //       }),
            // ),
            MainButton(text: 'Login', onPress: ()=>Navigator.pushNamed(context, '/log')),
            MainButton(text: "Register", onPress: ()=>Navigator.pushNamed(context, '/reg')),
            // Container(
            //   alignment: Alignment.center,
            //   height: mediaQueryForHeight(_mediaQuery, 0.085) +
            //       (_mediaQuery.orientation == Orientation.landscape ? 15 : 0),
